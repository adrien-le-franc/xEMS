...
class Simulation(object):
    ...
    def __init__(self,
        ...
        """ Creates initial simulation state based on data passed in.
            ...
            :param battery_controller: type BatteryController init with battery parameters and period id
        """
        ...
        # battery controller initialization
    ...
    def simulate_timestep(self, current_time, timestep):
        ...
        proposed_state_of_charge = self.battery_controller.propose_state_of_charge(
            current_time,
...
if __name__ == '__main__':
    ...
    for site_id, parameters in tqdm(metadata.iterrows(), desc='sites\t\t\t', total=metadata.shape[0]):
        ...
        if site_data_path.exists():
            ...
            # controller: reset the site id
            battery_controller.set_site(site_id)
            ...
            for batt_id in tqdm([1, 2], desc=' > batteries \t\t'):
                ...
                # controller: reset the battery for this run
                battery_controller.set_battery(batt, batt_id)
                ...
                for g_id, g_df in tqdm(site_data.groupby('period_id'), total=n_periods, desc=' > > periods\t\t'):
                    ...
                    # controller: specify period id for training data selection
                    battery_controller.set_period(g_id)

                    sim = Simulation(g_df, batt, site_id, battery_controller)
